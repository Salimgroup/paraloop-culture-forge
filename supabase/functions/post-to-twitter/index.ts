...
import { verifyUserAuth, verifyServiceRoleKey, verifyHmacSignature, unauthorizedResponse, badRequestResponse } from "../_shared/auth.ts";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    let authenticated = (isServiceRole || isHmacValid) && isAutoMode;
